<nav id="sidebar">
    ...
    <ul class="list-unstyled components">
        ...
        <li class="active">
         ...
         <li>
            <a href="#pageSubmenuRue"  data-toggle="collapse" aria-expanded="false" class="fa fa-user-circle-o dropdown-toggle"> Farmers and Crops</a>
            <ul class="collapse list-unstyled" id="pageSubmenuRue">
                <li>
                    <a href="farmer_crop_add.php">Add</a>
                </li>

                <li>
                    <a href="farmer_crop_view.php">View</a>
                </li>
            </ul>
        </li>
